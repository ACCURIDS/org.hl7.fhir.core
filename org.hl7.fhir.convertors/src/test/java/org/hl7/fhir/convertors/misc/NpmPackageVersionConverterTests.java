...
public class NpmPackageVersionConverterTests extends ResourceLoaderTests {
  ...
  public void testNormalTgz() throws IOException {
    ...
    NpmPackageVersionConverter converter = new NpmPackageVersionConverter(null, null, "r5");
